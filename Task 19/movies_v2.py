...
def NextMovie(description):
    ...
    for movie in movies:
        ...
        # print(movie + "-" + str(similarity)) #print each movie with its similarity
        similarities.append(similarity)
        detailed.append(str(movie) + " -- " + str(similarity))
        dicts[similarity] = movie 
    print(max(similarities))
    #print(dicts) #to print everything in the dictionary
    return (dicts[max(similarities)])


print("Next Movie to Watch is: ", NextMovie((sentence_to_compare)))
